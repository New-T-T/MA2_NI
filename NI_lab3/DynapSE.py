    ...
    def add_connection(self, NeuronGroup1, NeuronGroup2, synapse_type='excitatory'):
        ...
        if synapse_type == 'NMDA':
            synapse = Synapses(NeuronGroup1, NeuronGroup2,
                    **dynapse_namd_syn_eq(), name='NMDA'+str(self.syn_id))
        elif synapse_type == 'AMPA':
            synapse = Synapses(NeuronGroup1, NeuronGroup2,
                    **dynapse_ampa_syn_eq(), name='AMPA'+str(self.syn_id))
        elif synapse_type == 'GABA_B':
            synapse = Synapses(NeuronGroup1, NeuronGroup2,
                    **dynapse_gabab_syn_eq(), name='GABA_B'+str(self.syn_id))
        else: 
            synapse = Synapses(NeuronGroup1, NeuronGroup2,
                    **dynapse_gabaa_shunt_syn_eq(), name='GABA_A'+str(self.syn_id))
